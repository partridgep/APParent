...
urlpatterns = [
    ...
    path('daily_report/<int:child_id>/<int:daily_report_id>/daily_report_detail/', views.daily_reports_detail, name='daily_reports_detail'),
    path('daily_report/<int:child_id>/add/', views.add_daily_report, name='add_daily_report'),
    path('daily_report/<int:child_id>/<int:daily_report_id>/daily_reports_edit/', views.daily_reports_edit, name='daily_reports_edit'),
